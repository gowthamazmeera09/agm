        ...
        <div>
            {
               ...
               <div class="container px-5 py-24 mx-auto">
                 <div class="lg:w-4/5 mx-auto flex flex-wrap">
                   <img alt={product.title} class="lg:w-1/3 w-full lg:h-50 h-100 object-cover object-center rounded" src={product.image}width="200px" />
                   <div class="lg:w-1/2 w-full lg:pl-10 lg:py-6 mt-6 lg:mt-0">
                     <h2 class="text-sm title-font text-gray-500 tracking-widest">{product.category}</h2>
                     <h3 className="text-gray-900 text-3xl title-font font-medium mb-5">{product.title}</h3>
                     <div class="flex mb-4">
